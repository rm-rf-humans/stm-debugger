...
#define IMU_1_hex 0x21;
#define IMU_1_hex 0x22;
#define IMU_1_hex 0x23;
#define IMU_1_hex 0x24;
#define IMU_1_hex 0x25;
#define IMU_1_hex 0x26;
...
void process_imu(uint8_t id, float value, DecodedData *current_msg)
{
    switch (id)
    {
    case 1:
        current_msg->imu.acc_x = value;
        break;
    case 2:
        current_msg->imu.acc_y = value;
        break;
    case 3:
        current_msg->imu.acc_z = value;
        break;
    case 4:
        current_msg->imu.imu_pitch = value;
        break;
    case 5:
        current_msg->imu.imu_roll = value;
        break;
    case 6:
        current_msg->imu.imu_yaw = value;
        break;
    default:
        break;
    }
...
void CAN_Receive_Callback(uint8_t sender_id, uint8_t *sequence, DecodedData *current_msg)
{
    ...
    case 0x26:
        float imu_data;
        memcpy(&imu_data, sequence, sizeof(float));
        process_imu(sender_id-0x20,imu_data, current_msg);
        break;
